  ...
  return (
    <Container sidebar={active} on onChange={closeSidebar}>
      ...
      <div id="Content">           
        ...
        {autenticado=="true"?<Link to="/Atletas"><SidebarItem Icon={FaRegCalendarAlt} Text="Atletas" /></Link>:<></>}
        ...
        {autenticado=="true"?<Link to="/Configuracoes/"><SidebarItem Icon={FaRegCalendarAlt} Text="Configurações" /></Link>:<></>}
      </div>
    </Container>
  )
}
